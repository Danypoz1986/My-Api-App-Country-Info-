import { IonAvatar, IonContent, IonHeader, IonImg, IonItem, IonLabel, IonList, IonPage, IonSearchbar, IonSelect, IonSelectOption, IonTitle, IonToolbar } from '@ionic/react';
  ...
  return (
    <IonPage>
      ...
      <IonSearchbar value={searchTerm}
        ...
        ></IonSearchbar>
        <IonItem>
          <IonSelect value={type} onIonChange={(e) => setType(e.detail.value as searchType)} label = "Select Search Type ">
