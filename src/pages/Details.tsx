...
import { business, map, language, cashOutline, earthOutline, people, resizeOutline, lockClosedOutline, carOutline, mail } from 'ionicons/icons';         
